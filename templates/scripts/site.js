(function ($) {
    ...
    function availabilityCalendar() {						
        ...
        if (calendarHtml.length > 0) {				
            ...
            calendarHtml.on(clickEventType, '.calendar-prev', function (e) {
				e.stopPropagation(); e.preventDefault();
                calendar.prevMonth();
            });

            calendarHtml.on(clickEventType, '.calendar-next', function (e) {
				e.stopPropagation(); e.preventDefault();
                calendar.nextMonth();
            });
        }
    ...
    $(function() {
        ...
        $(document).on(clickEventType, '.btn-mobile', function (e) {
			e.stopPropagation(); e.preventDefault();
        ...
        $(document).on(clickEventType, '.ripple-centered', function (e) {
			e.stopPropagation(); e.preventDefault();
        ...
        // open/close sidebar
        $(document).on(clickEventType, '.btn-sidebar', function (e) {
			e.stopPropagation(); e.preventDefault();
